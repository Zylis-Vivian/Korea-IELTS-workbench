...
5. 雅思听力先用示例文本熟悉流程，再通过「教材中心」或本地导入使用自己拥有的音频，不要把受版权保护的教材文件上传到公共仓库。
...
后续建议按以下顺序继续：真实授权音频与本地教材导入 → 听写与错词回流 → 韩语音变规则训练 → 雅思长难句逐层分析 → Whisper 转写和可懂度反馈。发音评分不应直接把语音转写正确率当成音素准确率。
